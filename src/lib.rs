pub fn parse_and_iterate_four(loop_counter: i32, number: i32) -> i32 {
    ...
    if result == 6174 {
        ...
        return parse_and_iterate_four(loop_counter + 1, result);
    }
}
...
pub fn calculate_four(num: i32) -> i32 {
    ...
    return parse_and_iterate_four(0, num);
}

pub fn parse_and_iterate_three(loop_counter: i32, number: i32) -> i32 {
    let int_to_str: String = number.to_string();
    let mut char_vec: Vec<char> = int_to_str.chars().collect();
    char_vec.sort(); // ascending vector
    let mut reversed_vec = char_vec.to_vec();
    ...
    if result == 495 {
        ...
        return parse_and_iterate_three(loop_counter + 1, result);
    }
}
...
pub fn calculate_three(num: i32) -> i32 {
    ...
    return parse_and_iterate_three(0, num);
}

pub fn main() {
    let answer_four = calculate_four(1234);
    let answer_three = calculate_three(114);
